...
# installed.
TCL_PREFIX='/usr/cross/m68k-elf'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/usr/cross/m68k-elf'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/src/cross/insight-weekly-6.5.50.20060612-i686-pc-linux-gnu-m68k-elf-out/tcl/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/cross/m68k-elf/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/usr/cross/m68k-elf/include'
...
# compiled.
TCL_SRC_DIR='/home/src/cross/insight-weekly-6.5.50.20060612/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/usr/cross/m68k-elf/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/src/cross/insight-weekly-6.5.50.20060612-i686-pc-linux-gnu-m68k-elf-out/tcl/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/cross/m68k-elf/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/src/cross/insight-weekly-6.5.50.20060612-i686-pc-linux-gnu-m68k-elf-out/tcl/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/cross/m68k-elf/lib/libtclstub8.4${TCL_DBGX}.a'
